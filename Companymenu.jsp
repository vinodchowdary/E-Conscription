  ...
  <tr>
	...
	<td width="155" valign="top" bgcolor="#666734"><p align="center">&nbsp;</p>
      <p align="center"><img src="logosit.jpg" width="113" height="112" /></p>
	    <p><a href="index.jsp">Home</a><br><a href="EditComProfile.jsp">Edit Profile</a>
        <br><a href="ChangePassword.jsp">Change Password</a>
        Job Details
        <br><a href="AddJobDetails.jsp">Add</a>
       <br><a href="ViewJobDetails.jsp">View</a>
        <br><a href="Exam.jsp">Exam
        <br><a href="ExamCreation.jsp">Exam Creation</a>
        <a href="ExamView.jsp">Exam View</a>
        <br><h1>Exam Results</h1>
        <br><h1>Question</h1>
        <br><a href="AddQuestions.jsp">Add</a>
        <br><a href="ViewQues.jsp">View</a>                                                
